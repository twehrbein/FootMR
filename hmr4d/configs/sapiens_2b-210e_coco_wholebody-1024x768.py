...
_base_ = ["../../third-party/sapiens/pose/configs/_base_/default_runtime.py"]
...
# optimizer
custom_imports = dict(
    imports=["mmpose.engine.optim_wrappers.layer_decay_optim_wrapper"], allow_failed_imports=False
)
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(
            from_file="third-party/sapiens/pose/configs/_base_/datasets/coco_wholebody.py"
        ),
    ),
)
val_dataloader = dict(
...
# evaluators
val_evaluator = dict(
    type="CocoWholeBodyMetric", ann_file="data/coco/annotations/coco_wholebody_val_v1.0.json"
)
